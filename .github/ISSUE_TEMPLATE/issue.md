...
Format : "[<module>] <short feature title in English>".
...
En tant que **<rôle>**, je veux **<objectif>**, afin que **<bénéfice / valeur>**.
...
<!-- Contraintes techniques, décisions d'architecture, pièges à éviter,
     périmètre exclu, références. Optionnel mais recommandé. -->
