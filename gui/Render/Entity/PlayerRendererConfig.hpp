...
constexpr float PLAYER_BROADCAST_DURATION = 1.5F;
constexpr float PLAYER_BROADCAST_FADE_DURATION = 0.3F;
constexpr float PLAYER_BROADCAST_ICON_Y = PLAYER_LABEL_Y + 0.4F;
constexpr float PLAYER_BROADCAST_ICON_RADIUS = 12.0F;
constexpr float PLAYER_BROADCAST_ICON_TAIL_LENGTH = 7.0F;
constexpr Color PLAYER_BROADCAST_ICON_COLOR = {255, 255, 255, 255};
constexpr Color PLAYER_BROADCAST_ICON_BORDER_COLOR = {40, 40, 40, 255};
constexpr int PLAYER_BROADCAST_ICON_FONT_SIZE = 12;
constexpr Color PLAYER_BROADCAST_ICON_TEXT_COLOR = {40, 40, 40, 255};
